...
public class User {
	...
	//2. 자바빈 패턴
	//getter/setter
	//단점 : public 메서드인 setter를 사용해 속성을 초기화하기 떄문에, 변경불가능한 (immutable)객체를 만들 수 없다.
	...
	public static class UserBuilder{
		...
		public UserBuilder password(String password) {
			...
			return this;//password 속성이 초기화된 UserBuilder
		}
		
		public UserBuilder email(String email) {
			this.email = email;
			return this;//email 속성이 초기화된 UserBuilder
		}
		
		public UserBuilder tell(String tell) {
			this.tell = tell;
			return this;//tell 속성이 초기화된 UserBuilder
		}
